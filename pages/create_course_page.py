...
from components.courses.create_course_exercises_form_component import CreateCourseExercisesFormComponent
...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_form = CreateCourseExercisesFormComponent(page)
        ...
        self.create_course_description_textarea = (
            page.get_by_test_id('create-course-form-description-input').locator(
                'textarea').first
        )
