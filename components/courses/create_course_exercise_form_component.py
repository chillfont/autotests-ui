...
class CreateCourseExerciseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.subtitle = Text(page, 'create-course-exercise-form-title-{index}-input', 'Exercise subtitle')
        self.title_input = Input(page, 'create-course-exercise-form-description-{index}-input', 'Title')
